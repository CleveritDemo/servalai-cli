---
description: Security and operations auditor. Reviews diffs and live cluster state for OWASP issues, secrets exposure, RBAC posture, container hardening, supply-chain risks. Read-only edit; read-only kubectl allowed. Outputs CRITICAL/HIGH/MEDIUM/LOW findings.
mode: subagent
temperature: 0.1
color: error
permission:
