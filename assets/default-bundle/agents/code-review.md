---
description: Quality gate. Reviews diffs and branches for SOLID, naming, test coverage, edge cases, error handling, performance, and TDD compliance. Read-only; never edits. Outputs structured BLOCKERS/MAJOR/MINOR/NITS report.
mode: subagent
temperature: 0.1
color: warning
permission:
